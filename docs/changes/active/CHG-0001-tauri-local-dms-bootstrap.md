...
| Decision records | ADR-0001 … ADR-0022 in `docs/design-decisions.md` |
...
**Current phase:** 0e is complete; phase 1 is pending. Set phase 1 to `in-progress` before implementation and keep only one phase in-progress.
