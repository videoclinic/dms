...
| 6 | Notes on documents | in-progress | Tests: note CRUD persistence across restart; list is newest-first; New note compose field is above the latest note and remains there after save |
...
**Current phase:** phase 5 is complete and synchronized; phase 6 is in progress. Keep only one phase in progress.
