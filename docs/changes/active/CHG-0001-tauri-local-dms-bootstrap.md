...
| 9g | Permalink OS integration | in-progress | Windows and macOS register `dms://`; inbound document/review/note links resolve workspace + stable document identity, focus or create the correct activity, survive rename/version changes, and fail closed for unavailable targets; platform smoke passes |
...
**Current phase:** 9g — Permalink OS integration.
