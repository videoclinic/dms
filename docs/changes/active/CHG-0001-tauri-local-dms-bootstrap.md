...
| 0b | Target-version review and failure-evidence records + wireframes | done (CAP-0002/0011/0012, ADR-0007/0013, architecture, and affected static screens updated) | CAP-0002/0011/0012 define the required changelog, minor/major/manual candidate selection, no-reservation rule, explicit release action, optional non-approval comment, and newest-first workflow history; CHG/ADR/architecture align; affected static screens show review target selection and retained unsuccessful evidence; generated exports, links, and Markdown checks pass; no CAP claims implemented runtime |
