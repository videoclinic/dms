...
- On the current Windows 11 host the policy key exists with neither `EntraClientId` nor `EntraTenantId`. The installed Start-menu target still reports product version `0.1.0` with a 2026-08-28 UTC modification time and no running desktop process.
