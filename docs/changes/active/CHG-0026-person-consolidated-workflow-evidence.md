...
| 2 | Amend CAP-0011 and regenerate the CAP-0011 wireframe | pending | CAP-0011 Outcome 4 states the per-person interval-block presentation and the absence of digest values in the pane; `node docs/product/wireframes/generate.mjs` exits 0; `html/CAP-0011-approval-evidence.html` and `exports/CAP-0011-approval-evidence.png` are regenerated and `manifest.json` still lists 21 screens |
