...
**Status:** in-progress — Phase 4 adds the library-session device-flow challenge.
...
- Device-flow challenge IPC remains Phase 4; activation still uses only a cached or refreshable delegated token.
