...
**Status:** pending — queued after P0600 and blocked until CHG-0035 Phase 3 evidence exists.
...
- CHG-0035 Phase 3 is still pending. Until that phase routes the cached verified Entra actor through desktop mutations and bound `WorkspaceSummary.change_author`, the candidate form has no session principal it can safely preselect (`docs/changes/active/CHG-0035-entra-session-required-for-group-bound-library.md` heading `Phase 3`).
